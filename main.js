...
// let customerID= results.filter(item => item.order.customerId == "ERNSH" )
// console.log(customerID);


// ? 3) employeeİd- görə sortlayın

  //let employeeId = results.filter(item => item.order.employeeId);
  //let sorts = employeeId.sort((a, b) => a.order.employeeId - b.order.employeeId);
//  console.log(sorts);


//? 4) OrderDetailsi 3-dən çox olanları console-a yazdır

// let OrderDetails = results.filter(item => item.orderDetails.length > 3 );
// console.log( OrderDetails);


// ? 5) İD-si 11075 olanı tap və yazdır. (find)

// let id = results.find(results => results.order.id === 11075);
// console.log(id);
